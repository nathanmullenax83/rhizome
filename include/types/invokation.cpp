    ...
    namespace types {
        namespace invokation {
            static Dispatcher dispatcher({
                {
                    "evaluate",[]( Thing *that, Thing *arg ) {
                        return ((Invokation*)that)->evaluate(arg);
                    }
                }
            });
            ...
            Invokation::clone() const {
                Invokation *inv = new Invokation(target,method_name,arg->clone());
                return inv;
            }
